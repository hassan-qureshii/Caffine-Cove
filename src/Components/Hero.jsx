  ...
  return (
    ...
    <div className="relative w-full min-h-[610px] flex items-center justify-center px-4 py-4 md:px-7 bg-gradient-to-r from-slate-800 to-slate-700 font-sans overflow-hidden">
      ...
      <motion.div
        ...
        className="uppercase font-extrabold font-mono text-6xl md:text-9xl text-slate-900 absolute lg:top-10 left-1/2 -translate-x-1/2 w-full text-center pointer-events-none select-none"
      >
        Caffine Cove
      </motion.div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 place-items-center gap-10 max-w-[1200px] mx-auto">
        ...
        <motion.div
          ...
          className="px-4"
        >
          <h1 className="text-5xl font-black text-[#EFE9DD] lg:mb-20 md:mb-10 lg:text-7xl">
            Black Cup
          </h1>
          <div className="text-[#FEEBDD]">
            <h3 className="text-2xl font-black py-4">
              A rich and bold coffee blend.
            </h3>
        ...
        <motion.div
          ...
          whileInView={{ x: 0, opacity: 1 }}
          transition={{ duration: 1 }}
          className="lg:mt-20 text-[#FEEBDD] px-4"
        >
