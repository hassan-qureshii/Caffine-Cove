      ...
      <div className="bg-gradient-to-r from-slate-800 to-slate-700 text-[#FEEBDD] w-full mx-auto">
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-center md:justify-start font-inter">
              <BiPhoneCall /><p className="ml-2">+1234567890</p>
            </div>
            <div className="flex items-center justify-center md:justify-start mt-2 font-inter">
          ...
          {/* Col-2 */}
          <motion.div
            className="py-10 px-4 text-center md:text-left"
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="flex flex-row justify-center md:justify-start gap-4 mt-4">
              {[FaFacebook, FaInstagram, FaGithub, FaLinkedin, FaTwitter].map((Icon, i) => (
                <Icon
                  key={i}
                  size={24}
                  className="opacity-55 hover:opacity-100 hover:scale-110 transition cursor-pointer"
                />
              ))}
            </div>
            <div className="mt-6">
              ...
              <div className="flex justify-center md:justify-start gap-4">
                {[FaCcVisa, FaCcMastercard, FaCcPaypal, FaCcAmex, FaCcDiscover].map((Icon, i) => (
                  <Icon
                    key={i}
                    size={28}
                    className="text-white opacity-70 hover:opacity-100 hover:scale-110 transition cursor-pointer"
                  />
                ))}
              </div>
            </div>
